 ...
 *  A hiba elkövetését a "mindent írjunk egy fájlba" gondolat/gyakorlat
 * mágnesként vonzza.
 *
 *  A hiba igazi oka a kompatibilitásból fakadó típuskonverzióra vezethető
 * vissza.
 *
 *
 */
...
/// @return os - ostream
inline std::ostream& operator<<(std::ostream& os, const Ellipszis& el) {
    return os << "Ellipszis " << (Alakzat&)el << ",r=" << el.getr()
              << ",e=" << el.gete();
}

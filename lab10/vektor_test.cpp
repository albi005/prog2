...
/// 1. feladat:
        ...
        cout << "otos: ";
        ostreamFunctor<double> doubleout(cout, ", ");
        std::for_each(otos.begin(), otos.end(), doubleout);
		cout << endl;
#endif // ELKESZULT >= 2
        ...
        cout << "darr: ";
		std::for_each(darr.begin(), darr.end(), doubleout);
		cout << endl;
#endif // ELKESZULT >= 3
        ...
        cout << std::count_if(it1, it1+10, negativ<int>());
		cout << endl;
#endif // ELKESZULT >= 6
        ...
        cout << std::count_if(darr.begin(), darr.end(), std::bind2nd(lt, 100));
		cout << endl;
#endif // ELKESZULT >= 8

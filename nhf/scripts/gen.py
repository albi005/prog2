...
for ownerId in range(1, 30):
    ...
    for _ in range(random.randint(0, 5)):
        ...
        print(random.choice(["Kutya", "Macska", "Kutya", "Macska", "Kutya", "Macska", "Nyúl", "Hörcsög", "Egér"]),
              file=a)

        treatmentDates = sorted([fake.unix_time(start_datetime=five_years_ago, end_datetime=current_date) for _ in
